...
const authError = (error: unknown): { status: number; message: string } => {
  ...
  if (code === "INVALID_PASSWORD") return { status: 400, message: "密码不能为空。" };
