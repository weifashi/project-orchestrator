...
export function WorkflowEditorPage() {
  ...
  const stageGroup = useMemo(() => stage ? draft?.envelope.data.canvas?.groups?.find((group) => group.stage_keys.includes(stage.key)) : undefined, [draft, stage]);
