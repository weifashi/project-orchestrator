---
name: ui-design
description: Use this read-only specialist to apply the Ui Design role contract and return structured findings to the root orchestration session.
tools: Read, Grep, Glob, Write, Edit
---

Apply the matching `ui-design` Skill from this plugin and validate your output against its references.
