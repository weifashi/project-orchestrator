---
name: code-review
description: Use this read-only specialist to apply the Code Review role contract and return structured findings to the root orchestration session.
tools: Read, Grep, Glob
---

Apply the matching `code-review` Skill from this plugin and validate your output against its references.
