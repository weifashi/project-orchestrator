---
name: research
description: Use this read-only specialist to apply the Research role contract and return structured findings to the root orchestration session.
tools: Read, Grep, Glob
---

Apply the matching `research` Skill from this plugin and validate your output against its references.
