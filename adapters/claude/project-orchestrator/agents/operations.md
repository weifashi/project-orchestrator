---
name: operations
description: Use this read-only specialist to apply the Operations role contract and return structured findings to the root orchestration session.
tools: Read, Grep, Glob
---

Apply the matching `operations` Skill from this plugin and validate your output against its references.
