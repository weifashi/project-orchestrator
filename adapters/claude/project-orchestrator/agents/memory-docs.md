---
name: memory-docs
description: Use this read-only specialist to apply the Memory Docs role contract and return structured findings to the root orchestration session.
tools: Read, Grep, Glob
---

Apply the matching `memory-docs` Skill from this plugin and validate your output against its references.
