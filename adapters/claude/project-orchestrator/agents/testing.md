---
name: testing
description: Use this read-only specialist to apply the Testing role contract and return structured findings to the root orchestration session.
tools: Read, Grep, Glob, Bash
---

Apply the matching `testing` Skill from this plugin and validate your output against its references.
